...
function clicar() {
    ...
    var title2 = document.getElementById('title2') // variavel para title h2
    ...
    window.alert(`Invalide date. Please try again`)
        ...
        document.getElementById("div1").style.height = "fit-content";

        document.getElementById("title2").style.margin = "20px 0px 5px 0px";
        ...
        if (month.value == 'March' && Number(day.value) >= 21 || month.value == 'April' && Number(day.value) < 20){
            ...
            title2.innerHTML = 'ARIES'

            img.setAttribute('src', './images/aries.jpg')
            ...
            title2.innerHTML = 'TAURUS'
            img.setAttribute('src', './images/taurus.jpg')
            ...
            title2.innerHTML = 'GEMINI'
            img.setAttribute('src', './images/gemini.jpg')
            ...
            title2.innerHTML = 'CANCER'
            img.setAttribute('src', './images/cancer.jpg')
            ...
            title2.innerHTML = 'LEO'
            img.setAttribute('src', './images/leo.jpg')
            ...
            title2.innerHTML = 'VIRGO'
            img.setAttribute('src', './images/virgo.jpg')
            ...
            title2.innerHTML = 'LIBRA'
            img.setAttribute('src', './images/libra.jpg')
            ...
            title2.innerHTML = 'SCORPIO'
            img.setAttribute('src', './images/scorpio.jpg')
            ...
            title2.innerHTML = 'SAGITTARIUS'
            img.setAttribute('src', './images/sagittarius.jpg')
            ...
            title2.innerHTML = 'CAPRICORN'
            img.setAttribute('src', './images/capricorn.jpg')
            ...
            title2.innerHTML = 'AQUARIUS'
            img.setAttribute('src', './images/aquarius.jpg')
            ...
            title2.innerHTML = 'PISCES'
            img.setAttribute('src', './images/pisces.jpg')
